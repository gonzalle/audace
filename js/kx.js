...
//wheel vWheel
        ...
        cleanup_6: {
            ...
            run: function() {
                ...
                var x = 13;
                var cdspan = this.built.querySelector('.cd');
