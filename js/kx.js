       ...
       // return;
        ...
        `);}},
            ...
            for (var [key, value] of Object.entries(app.data.recipes)) {
               ...
               rhtml += `
                <div class="recetteScrollerItem" data-val="${key}"><div class="title"><span>${value.name}</span></div><div class="thumb"><img nopin = "nopin" data-alt="${imag('ristretto')}" src="images/recipesSheet.png" style="object-position: ${'-'+((value.spritexy.split(';'))[0]*150)+'px'} ${'-'+((value.spritexy.split(';'))[1]*150)+'px'}"></div></div> 
                 `;
            }
            ...
            return (rhtml);
                ...
                <div class="centralArea" style="position:absolute;width:222px;left:129px;height:100%;background-color:rgba(255,255,255,0.2)">
                    ...
                    transform: scale(1.1);
                    ">
                    <img class="recipeImage" nopin = "nopin" data-alt="${imag('ristretto')}" src="images/recipesSheet.png" style="width: 900px;
                    position:absolute;
                    height: 900px;
...
var hscroller = function (e) {
    ...
    that.element.addEventListener('mousemove', (e) => {
        ...
        const walk = (x - that.startX) * 1; // increase to scroll faster
