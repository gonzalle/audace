(function() {
    ...
    const kxapp = function() {
        ...
        if (localStorage.getItem('lg'))  {
            ...
            if (kxLg[window.navigator.language.slice(0, 2)]){
                app.lg =  window.navigator.language.slice(0, 2);
             } else {
                 app.lg = "en";
             }
...
app.beep = function() {
    /* */
            const snd = new Audio(imag('beep'));
            snd.loop = false;
            snd.play();
        };
app.bleep = function() {
            const snd = new Audio(imag('bleep'));
            snd.loop = false;
            snd.play();
        };
const baseHtml = (`
        ...
        <div class="pleaseRotate">
            <svg style="" viewBox="0 0 32 32">
                <use href="#kxPleaseRotate" />
            </svg>
            <div class="closePleaseRotate">&times;</div>
        </div>
...
app.buildPage = function(pageId, data, callback) {
        ...
        app.showPage = function(page, fade, callback) {
            // app.canSwitchPage = false;
            let pageTransitionTime = 500;
            ...
            if (fade) {
                ...
                Object.assign(prevHolder.style, {
                    opacity: 0,
                    transition: 'opacity '+pageTransitionTime+'ms',
                    pointerEvents: 'none',
                });
        ...
        app.pages = {
            ...
            starting: {
                ...
                run: function() {
                    ...
                    Object.assign(this.built.querySelector('.logoKrups').style, {
                        'transition': 'opacity ease-in 900ms 300ms',
                        'opacity': '1',
                    });
                    Object.assign(this.built.querySelector('.bar').style, {
                        'transition': 'width 700ms cubic-bezier(0.12, 0.59, 0.38, 1) 900ms',
                        'width': '100%',
                    });
                    Object.assign(this.built.querySelector('.glowPoint').style, {
                        'transition': 'transform 700ms cubic-bezier(0.12, 0.59, 0.38, 1) 900ms, opacity 0ms 900ms, left 0ms 1700ms',
                        'transform': 'translateX(350px)',
                        'opacity':"1",
                        'left':'-500px',
                    });

                    Object.assign(this.built.querySelector('.intuition').style, {
                        'transition': 'opacity 900ms ease-in 850ms',
                        'opacity': '1',
                    });

                    Object.assign(document.querySelector('.logoGroup').style, {
                        'transform': 'translateX(-470px)',
                        'transition': 'transform 300ms linear 2400ms' ,
                    });
                ...
                <div class="logoGroup" style="position:absolute;top:0;left:0">
                  <svg class="logoKrups" style="opacity:0; position:absolute; top:110px; left:167px; width:146px;height:34px;" viewBox="0 0 146 34">
                  <use href="#krupsLogo" style="fill: white;" />
                  </svg>
                  <div class="barBkg" style="position:absolute; left:69px; top:159px; width:350px; height:1px; overflow:visible">
                      <div class="bar" style="width:0;height:1px;background-color:rgba(255, 255, 255, 0.55);">
                      <div class="glowPoint" style="opacity:0; position:absolute; left:0; top:-3px; background-color:white; width:6px;height:6px; box-shadow: white 0px 0px 5px 1px, white 0px 0px 17px 1px;
                      ; border-radius:6px;">
                      </div>
                      </div>
                  </div>
                  <div class="intuition" style="
                  opacity:0; 
            ...
            recettes: {
                ...
                run: function() {
                    ...
                    app.currentProfile = false;
                    //this.built.classList.add('run');
                    Object.assign((this.built.querySelector('.recetteScrollerItem:first-child')).style, {
                        'transform': 'translateX(0)',
                    });
                    Object.assign((this.built.querySelector('.recetteScrollerItem:nth-child(2)')).style, {
                        'transform': 'translateX(0)',
                        'transition-delay':'.2s'
                    });
                    Object.assign((this.built.querySelector('.recetteScrollerItem:nth-child(3)')).style, {
                        'transform': 'translateX(0)',
                        'transition-delay':'.4s'
                    });
                ...
                <style>
                    ...
                    .kx .home .recetteScrollerItem:first-child{
                    margin-left: 19px;
                    transition-delay:0;
                    }

                    
                    .kx .home .recetteScrollerItem:last-child{
                        margin-right: 19px;
                    }
                    .kx .pageContent.run .recetteScrollerItem{
                ...
                <section id="recetteScroller" class="hScroller" >
                    ...
                    for ( const [key,value] of Object.entries(app.recipes)) {
                        rhtml += `
                <div class="recetteScrollerItem recette" data-val="${key}" style="${  (i < 3) ?  "transform:translateX(480px);  transition:transform .8s;" : "" }">
                <div class="title">
            ...
            .kx .selection .validaterecipe{
                opacity:initial;
                pointer-events: initial;
            }
            .kx .addRecipe .recetteScrollerItem{
                width:110px;
                overflow:hidden;
            }
  
            .kx .addRecipe .recetteScrollerItem .title{
                left: 2px;
                font-size: 13px;
                width: 105px;
                height: 23px;
            ...
            .kx .addRecipe .recetteScrollerItem .userTitleClip{
                left : 40px;
                top : 29px;
            }
  
            .kx .addRecipe .recetteScrollerItem .thumb{
                transform: scale(0.6);
            ...
            .kx .recetteScrollerItem.selected {
                background: rgba(255, 255, 255, 0.38);
            }
            .kx .addRecipe .hScroller{
                top:113px;
                height:125px;
            }
            .kx .addRecipe .recetteScrollerItem:first-child {
                margin-left: 71px;
                transition-delay: 0;
            }
            ...
            prepare: {
                ...
                `;
                    ...
                    <style>
                    .kx .canceled .hideOnCancel{
                        opacity:0!important;
                    }
                    .kx .canceled .dimOnCancel{
                        opacity:0.3;
                    }
                    .kx .cancelIcon{
                        display:none;
      ...
      `;
            ...
            setups: {
                ...
                build: function(callback) {
                    ...
                    this.slider = new hslider(thisBuilt.querySelector('.slides'), true,  function(c) {
            ...
            informations: {
                ...
                build: function(callback) {
                    ...
                    this.slider = new hslider(thisBuilt.querySelector('.hScroller'), false, 
                      function(){}
                    );
                    callback();
                },
            ...
            <div class=" backButton">
                ...
                .kx .InfoBlock{
                    ...
                    .kx .InfoBlock:last-child{
                        border-right : unset;
                    }
  
                    .kx .InfoBlock .infoScrollerItem{
                        width: 305px;
                        height:75px;
                        top:0;
                        font-size:18px;
                    ...
                    .kx .InfoBlock .infoScrollerItem:nth-child(2){
                        top:75px;
                    }
  
                    .kx .InfoBlock .infoScrollerItem:nth-child(3){
                        top:150px;
                    }
  
                    .kx .InfoBlock .infoScrollerItem .title{
                        position: absolute;
                        left: 100px;
                        top: 25px;
                        font-size: 20px;
                    ...
                    .kx .InfoBlock .infoScrollerItem.totalLine .title{
                        left: 24px;
                        font-weight:bold;
                    }
  
                    .kx .InfoBlock .infoScrollerItem .counter{
                        position: absolute;
                        right: 25px;
                        top:25px;
                        font-size: 20px;
            ...
            <span class="title">${_(this.name)}</span>
                ...
                <style>
               .kx .langScroller.wheel.vWheel.left {
                    width: 208px;
                }
        ...
        <div class="userTitleClip wide userBorderColor"></div>
            ...
            <div class="backToMain backButton">
                ...
                <style>
                .kx .firstName .hScroller{
                    top: 185px;
                    height: 50px;
                    padding-top: 10px;
                }
  
                .kx .firstName .hScrollerItem {
                    width: 47px;
                    height: 42px;
                    text-align: center;
                    margin-right: 0;
                ...
                .kx .firstName .hScrollerItem:last-child {
                    border-right:none;
                }
  
                .kx .firstName .hScrollerItem span {
                    font-size:28px;
                    line-height:36px;
                }
            ...
            color: {
                ...
                html: function() {
                    ...
                    for (const [key,value] of Object.entries(kxColors)) {
                        colorScrollerItems += `
                        <div class="hScrollerItem" data-name="${key}" data-val="${value}">
                    ...
                    <div class="backToMain backButton">
                        ...
                        .kx .colors .hScrollerItem:last-child {
                            border-right:none;
                        }
        
                        .kx .colors .hScrollerItem div {
                            display: inline-block;
                            font-size: 6px;
                            line-height: 37px;
                            width: 70px;
                        ...
                        .kx .colors .hScrollerItem.selected div {
            ...
            program: {
                ...
                html: function() {
                    ...
                    <div class="userTitleClip wide userBorderColor"></div>
                        ...
                        .kx .block .checkbox.checked .inner{
                            display:block;
                        }
        ...
        <div class="userTitleClip wide userBorderColor"></div>
            ...
            dateTime: {
                ...
                html: function() {
                    ...
                    const rhtml = `
                        ...
                        <div class="pageContent dateTime bkg16 orange">
           ...
           <div class="aSwitch switchLeft">
            ...
            <div class="backToMain backButton">
                ...
                .kx .help .hScrollerItem:first-child {
                    margin-left:29px;
                }
  
                .kx .help .hScrollerItem:last-child {
                    margin-right:29px;
                }
  
                .kx .help .hScrollerItem .icon {
                    width: 122px;
                    height: 40px;
                    position: absolute;
                    left: 19px;
                ...
                .kx .help .hScrollerItem .video.icon {
                    width: 122px;
                    height: 40px;
                    position: absolute;
                    left: 19px;
                ...
                .kx .help .hScrollerItem .icon svg {
                    width:32px;
                    height:32px;
                }
  
                .kx .help .hScrollerItem .desc {
                    position: absolute;
                    top: 67px;
                    width: 138px;
                    left: 10px;
            ...
            <div class="pageContent ${this.name} bkg16">
                <style>
                .kx .${this.name}.running .startButton{
                    display:block;
                }
                .kx .${this.name}.running .progressBarBkg{
                    left:154px;
                }
                </style>
                <div class="titleBlock light wide">
        ...
        app.recipes = {
            ...
            americano: {
                ...
                leftmenudefault: '2',
                rightmenutyp: 'ml',
                rightmenuvalues: '80;90;100;110;120;130;140;150',
                rightmenudefault: '120',
                step2Typ: 'false',
                step2Values: 'false',
                step2Default: 'false',
        ...
        app.init = function(kxhost) {
            ...
            app.kxParent = app.kxunit.parentElement;
            //transition: transform .5s;
            ...
            app.kxParent.querySelector('.closePleaseRotate').addEventListener('click', ()=>{
                app.kxParent.querySelector('.pleaseRotate').remove();
            }
            );

            app.kxParent.querySelector('.kxfullScreen').addEventListener('click', ()=>{
                if (document.fullScreenElement || document.mozFullScreen || document.webkitIsFullScreen || document.msIsFullScreen) {
                    var exitMethod = document.cancelFullScreen || document.webkitCancelFullScreen || document.mozCancelFullScreen || document.msCancelFullscreen || document.msCancelFullScreen;
                    exitMethod.call(document);
                } else {
                    var requestFullScreen = app.kxParent.requestFullscreen || app.kxParent.mozRequestFullScreen || app.kxParent.webkitRequestFullscreen || app.kxParent.msRequestFullscreen;
                    requestFullScreen.call(app.kxParent);
                }
            }
            );
...
function addStyles(destination) {
        ...
        <g id="kxFullScreen" viewBox="0 0 32 32" style="fill:none;stroke:#FFFFFF;stroke-width:2;">
            <polyline points="11.8,3 3,3 3,11.8 	"/>
            <polyline points="28.8,11.8 28.8,3 20,3 	"/>
            <polyline points="3,20 3,28.8 11.8,28.8 	"/>
            <polyline points="20,28.8 28.8,28.8 28.8,20 	"/>
        </g>


        <g id="kxPleaseRotate" viewBox="0 0 32 32">
        <path style="opacity:0.26;fill:none;stroke:#FFFFFF;stroke-width:2;stroke-miterlimit:10;" d="M20.9,29.7h-9.7
            c-1.5,0-2.7-1.2-2.7-2.7V5c0-1.5,1.2-2.7,2.7-2.7h9.7c1.5,0,2.7,1.2,2.7,2.7V27C23.6,28.5,22.4,29.7,20.9,29.7z"/>
        <path style="fill:none;stroke:#FFFFFF;stroke-width:2;stroke-miterlimit:10;" d="M2.3,20.8v-9.7c0-1.5,1.2-2.7,2.7-2.7H27
            c1.5,0,2.7,1.2,2.7,2.7v9.7c0,1.5-1.2,2.7-2.7,2.7H5.1C3.6,23.6,2.3,22.3,2.3,20.8z"/>
            <path style="fill:#FFFFFF;" d="M16,19.1c-1.7,0-3-1.3-3.1-3h0.9l-1.7-2.2l-1.7,2.2h0.9c0.1,2.5,2.1,4.5,4.6,4.5
                c0.4,0,0.8-0.3,0.8-0.8S16.4,19.1,16,19.1z"/>
            <path style="fill:#FFFFFF;" d="M20.6,15.9c-0.1-2.5-2.1-4.5-4.6-4.5c-0.4,0-0.8,0.3-0.8,0.8s0.3,0.8,0.8,0.8c1.7,0,3,1.3,3.1,3
                h-0.9l1.7,2.2l1.7-2.2H20.6z"/>
        </g>
...
const ret = function(t) {
        ...
        let hslider = function(e, isAutomove, callback) {
            const that = this;
            that.element = e;
            that.isDown = false;
            that.startX = null;
        ...
        let vscroller = function(e, centerTarget) {
            const that = this;
            that.isDown = false;
            that.startY = null;
            that.scrollTop = null;
