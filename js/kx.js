       ...
       // return;
        ...
        `)}},
            ...
            for (let [key, value] of Object.entries(app.data.recipes)) {
               ...
               rhtml += `
                <div class="recetteScrollerItem" data-val="${key}"><span>${value.name}</span><div class="thumb"><img data-alt="${imag('ristretto')}" src="images/recipesSheet.png" style="object-position: ${'-'+((value.spritexy.split(';'))[0]*150)+'px'} ${'-'+((value.spritexy.split(';'))[1]*150)+'px'}"></div></div> 
                 `
            }
            ...
            righmenudefault:'M',
            runmenutyp:'ml',
            runmenuvalues:'20;25;30;35;48',
            runmenudefault:'60',
            },
            lattemacchiatox2:{code:'lattemacchiatox2',
            name:'LATTE MACCHIATO + X2',
            spritexy:'0;0',
            spritexyx2:'0;0',
            family:'latte',
            sequences:'steam;cafe',
