    ...
    app.pages = {
        ...
        prepare: {
            ...
            run: function() {
                ...
                if (app.currentProfile && !adding) {
                    if(this.strengthScroller) this.strengthScroller.pause = true;
        ...
        firstName: {
            ...
            build: function(callback) {
                ...
                // debugger;
                    ...
                    ?   _('remains').replace('%s', maxChar - n.length)
                    :   _('remains').replace('%s', maxChar - n.length);
                }
